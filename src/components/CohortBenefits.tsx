  ...
  const benefits = [
    {
      ...
      description: 'Your vehicle profile helps Astrateq understand which Canadian driver and vehicle types should be prioritized.',
      detail: 'Our team cross-references your specifications with our telemetry readiness parameters.',
      icon: Sliders,
    ...
    },
    {
      ...
      description: 'Receive updates as the software-led readiness intelligence experience evolves.',
      detail: 'Be first to try new web features, result diagnostics, and digital driving profiles.',
      icon: Calendar,
      accentColor: 'bg-[#00BFEF]',
      iconBg: 'bg-[#EAF7FF]',
      iconBorder: 'border-[#BFE7FA]',
    ...
    },
    {
      ...
      description: 'Eligible early participants may receive pricing consideration if rollout moves forward.',
      detail: 'Lock in early supporter pricing and benefits if we expand the program.',
    ...
    },
    {
      ...
      description: 'Your input helps shape readiness categories, result logic, privacy expectations, and future feature direction.',
      detail: 'Join private feedback surveys and participate in focus groups shaping Canadian weather readiness logic.',
      icon: Sparkles,
      accentColor: 'bg-[#00BFEF]',
      iconBg: 'bg-[#EAF7FF]',
      iconBorder: 'border-[#BFE7FA]',
    ...
    },
    {
      ...
      description: 'Receive transparent updates about validation progress, software improvements, and future hardware direction.',
      detail: 'Get authentic, spam-free updates directly from our development and engineering team.',
      icon: Mail,
      accentColor: 'bg-[#00BFEF]',
      iconBg: 'bg-[#EAF7FF]',
      iconBorder: 'border-[#BFE7FA]',
