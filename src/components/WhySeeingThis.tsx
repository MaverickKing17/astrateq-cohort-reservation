    ...
    <section className="bg-slate-900/40 py-16 border-b border-slate-900" id="why-us">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
          ...
          {/* Card 1 */}
          <div className="rounded-xl border border-slate-800/80 bg-slate-900/50 p-6 flex flex-col items-center text-center shadow-lg hover:border-slate-700 transition-all duration-200">
            ...
            <div className="mt-auto pt-4 flex items-center space-x-1.5 text-cyan-400 font-medium text-[11px]">
